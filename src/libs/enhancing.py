...
def ridge_orient(image: np.array, sigma_gradient: int, sigma_block: int, sigma_orientation: int):
    ...
    gauss = cv2.getGaussianKernel(int(size), sigma_gradient)
    ...
    gauss = cv2.getGaussianKernel(int(size), sigma_block)
    f = gauss * gauss.T
    ...
    if sigma_orientation:
        ...
        gauss = cv2.getGaussianKernel(int(size), sigma_orientation)
